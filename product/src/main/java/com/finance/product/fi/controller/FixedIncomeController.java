...
import com.finance.common.product.entity.dto.SaveProductResponse;
import com.finance.common.product.entity.fi.dto.SaveFixedIncomeRequest;
...
public class FixedIncomeController {
    ...
    public SaveProductResponse Create(@RequestBody SaveFixedIncomeRequest fi) {
        return null; // fixedIncomeService.Create(fi);
    }
